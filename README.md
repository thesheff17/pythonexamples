...
* you should run this inside a virtualenv setup.  A virtualenv is an isolated area to install 3rd
  ...
  [requirements.txt](https://github.com/thesheff17/pythonexamples/blob/master/requirements.txt). pip is the package manager to install 3rd party tools for python.
* Each platform is different.  You can learn more about it [here](https://packaging.python.org/guides/installing-using-pip-and-virtual-environments/) file.
